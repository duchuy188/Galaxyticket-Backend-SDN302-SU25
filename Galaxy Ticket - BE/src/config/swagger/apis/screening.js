module.exports = {
          ...
          content: {
            'application/json': {
              schema: {
                type: 'object',
                properties: {
                  movieId: { type: 'string', example: '60f7c0b8e1b1c8a1b8e1b1c8' },
                  roomId: { type: 'string', example: '60f7c0b8e1b1c8a1b8e1b1c9' },
                  startTime: { type: 'string', format: 'date-time', example: '2024-06-01T14:00:00.000Z' },
                  endTime: { type: 'string', format: 'date-time', example: '2024-06-01T16:00:00.000Z' },
                  status: { type: 'boolean', example: true },
                  ticketPrice: { type: 'number', example: 90000 }
                },
                required: ['movieId', 'roomId', 'startTime', 'endTime', 'ticketPrice']
              }
            }
          }
        },
    ...
    '/screenings/{id}': {
      get: {
        ...
        responses: {
          ...
          404: { description: 'Không tìm thấy suất chiếu' }
        }
      },
      put: {
        tags: ['Screening'],
            ...
            content: {
              'application/json': {
                schema: {
                  type: 'object',
                  properties: {
                    isOverlap: { type: 'boolean', example: false },
  ...
  // components/schemas/Screening sẽ được định nghĩa ở phần swagger chính